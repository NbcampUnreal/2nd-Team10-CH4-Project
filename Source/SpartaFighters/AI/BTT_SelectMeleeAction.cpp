...
void UBTT_SelectMeleeAction::SelectActionForIdleTarget(EAIActionType& NewAction, EAIState& NewState)
{
...
void UBTT_SelectMeleeAction::SelectActionForCrouchTarget(EAIActionType& NewAction, EAIState& NewState)
{
    const int32 BasicAttack = 60;
    const int32 CrounchAttack = 10;
    const int32 JumpAttack = 10;
...
void UBTT_SelectMeleeAction::SelectActionForJumpTarget(EAIActionType& NewAction, EAIState& NewState)
{
...
void UBTT_SelectMeleeAction::SelectActionForMoveTarget(EAIActionType& NewAction, EAIState& NewState)
{
    const int32 BasicAttack = 60;
    const int32 CrounchAttack = 10;
    const int32 JumpAttack = 10;
...
void UBTT_SelectMeleeAction::SelectActionForGuardTarget(EAIActionType& NewAction, EAIState& NewState)
{
    const int32 BasicAttack = 60;
    const int32 CrounchAttack = 10;
    const int32 JumpAttack = 10;
...
void UBTT_SelectMeleeAction::SelectActionForAttackTarget(EAIActionType& NewAction, EAIState& NewState)
{
    const int32 BasicAttack = 60;
    const int32 CrounchAttack = 10;
    const int32 JumpAttack = 10;
...
void UBTT_SelectMeleeAction::SelectActionForRollTarget(EAIActionType& NewAction, EAIState& NewState)
{
    const int32 BasicAttack = 60;
    const int32 CrounchAttack = 10;
    const int32 JumpAttack = 10;
